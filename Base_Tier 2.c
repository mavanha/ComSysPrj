...
// ---------- MIC: thresholds ----------
#define MIC_AMPL_THRESHOLD   8000   // avg abs amplitude threshold (tune)
#define MIC_DOT_MAX_MS       250    // <= this → dot, else dash
...
static void mic_task(void *pvParameters);             // MIC
...
static void on_pdm_samples_ready(void);              // MIC
...
int main() {
    ...
    xTaskCreate(mic_task,      "MicTask",      1024, NULL, MAIN_TASK_PRIORITY, NULL); // MIC
